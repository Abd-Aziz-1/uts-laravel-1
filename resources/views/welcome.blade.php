    ...
    <style>
        ...
        .hero-bg {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                        url('{{ asset('images/foto-3.jpg') }}') center/cover;
            position: relative;
            overflow: hidden;
        }
        ...
        <div class="container mx-auto px-4 hero-content">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right">
                    <h1 class="text-6xl md:text-8xl font-bold mb-4 gradient-text">JOKI BABE MUDA ML</h1>
                    <p class="text-xl md:text-2xl text-gray-300 mb-8">Top Global Assassin | Professional Player</p>
                ...
                <div class="relative" data-aos="fade-left">
                    <img src="{{ asset('images/foto-2.jpg') }}" alt="Player Avatar" class="rounded-full w-full max-w-md mx-auto glow-effect">
                ...
                <div class="swiper-wrapper pb-12">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-card bg-gray-800/50 rounded-2xl overflow-hidden">
                            <img src="{{ asset('images/foto-5.jpg') }}" alt="Hero 1" class="w-full">
                            <div class="p-6">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-card bg-gray-800/50 rounded-2xl overflow-hidden">
                            <img src="{{ asset('images/foto-4.jpg') }}" alt="Hero 2" class="w-full">
                            <div class="p-6">
                                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-card bg-gray-800/50 rounded-2xl overflow-hidden">
                            <img src="{{ asset('images/foto-6.jpg') }}" alt="Hero 3" class="w-full">
                            <div class="p-6">
                                <div class="flex justify-between items-center mb-4">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-800/50 rounded-2xl overflow-hidden" data-aos="fade-right">
                    <div class="relative">
                        <img src="{{ asset('images/foto-2.jpg') }}" alt="Stream Preview" class="w-full">
                ...
                <div class="space-y-4" data-aos="fade-left">
                    <div class="bg-gray-800/50 rounded-xl p-4 hover:bg-gray-700/50 transition cursor-pointer">
                        <div class="flex space-x-4">
                            <img src="{{ asset('images/foto-3.jpg') }}" alt="Stream Thumbnail" class="w-24 h-24 rounded-lg">
                            <div>
                ...
                <div class="match-history-item bg-gray-800/50 rounded-xl p-6" data-aos="fade-up">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <img src="{{ asset('images/foto-1.jpg') }}" alt="Hero" class="w-16 h-16 rounded-lg">
                            <div>
